...
const CustomerPendingWarrantiesDetailsWidget = ({ warranty }) => {
  ...
  //Navigate to The Warranty Details Page
  const handleNavigateClick = (tokenId) => {
    navigate("/product-details/${tokenId}");
  };

  return (
    <div className="flex w-full">
      <div
        className=" w-2/5 h-24 border-b-2 border-gray-100  text-xs pt-10 text-center"
        onClick={() => {
          handleNavigateClick(warranty.tokenId);
        }}
      >
